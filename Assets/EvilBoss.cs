...
public class EvilBoss : MonoBehaviour
{
    ...
    // Bounds for the room
    [SerializeField] Vector3 minBounds = new Vector3(6.75f, 4f);
    [SerializeField] Vector3 maxBounds = new Vector3(9.85f, 10.73f);
    ...
    void Start()
    {
        ...
        door = GameObject.FindGameObjectWithTag("cherylDoor");
